...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="../sablon/">Jenis Sablon</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container mt-4">
    ...
    <!-- Sablon Section -->
    <div id="sablon-section" class="mb-5">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h3>Jenis Sablon</h3>
        <a href="create.php" class="btn btn-success">
          <i class="bi bi-plus-circle"></i> Tambah Sablon
        </a>
      </div>
          ...
          <tbody>
            ...
            while ($row = $stmt->fetch()) {
              ...
              echo "<td>
                            ...
                            <a href='delete.php?id={$row['id']}' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\")'><i class='bi bi-trash'></i></a>
                          </td>";
              echo "</tr>";
            }
            ?>
